...
def userlist(request):
    # for fetch all record from mstuser 
...
def addbatch (request):
   if (request.method == "POST"):
      # SO we will fetch data to Django variables :-
      nm = request.POST.get ("nm")
...
def admission (request):
    if (request.method == "GET"):
        ...
        nm = request.POST.get ("nm")
        x  = datetime.datetime.now()  ## this will give me current date 
        ...
        #....................................................
        return redirect("/batchlist1/") # in case user wants to choose more courses 
